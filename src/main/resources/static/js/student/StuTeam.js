	...
	$.ajax({
        ...
        success:function(res){
			...
			for(var i=0;i<res.data.length;i++){
				var data = res.data[i];
				team_table.innerHTML+="<tr style='border: none'><td>"+data.team_name+"</td><td>"+data.plan_name+"</td><td>"+data.plan_name+"</td><td>"+data.sch_name+"</td><td>"+data.com_name+"</td><td><a href='"+"StuTeamInfo.html"+"' style='color: #b52e31'>查看</a> </td></tr>";
			}
