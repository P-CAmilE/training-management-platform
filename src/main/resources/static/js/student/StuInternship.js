	...
	$.ajax({
        ...
        success:function(res){
			...
			for(var i=0;i<res.data.length;i++){
				var data = res.data[i];
				project_table.innerHTML+="<tr style='border: none;background-color: rgb"+(i%2==0?"(248, 255, 247)":"(238, 217, 215)")+"'><td>"+data.pro_name+"</td><td>"+data.plan_name+"</td><td>"+data.start_time+"--"+data.end_time+"</td><td>"+data.sch_name+"</td><td><a href='StuInternshipInfo.html?pro_id="+data.pro_id+"' style='color: #b52e31'>查看</a> </td></tr>";
			}
