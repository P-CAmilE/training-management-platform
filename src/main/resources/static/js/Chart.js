		...
		callbacks: {
			...
			title: function(tooltipItems, data) {
				...
				if (tooltipItems.length > 0) {
					...
					} else if (data.labels.length > 0 && tooltipItems[0].StudentIndex < data.labels.length) {
						title = data.labels[tooltipItems[0].StudentIndex];
					}
				}
		...
		addElements: function() {
			...
			helpers.each(this.getDataset().data, function(value, index) {
				this.getDataset().metaData[index] = this.getDataset().metaData[index] || new Chart.elements.Rectangle({
					...
					_datasetIndex: this.StudentIndex,
					_index: index,
				});
			}, this);
		},
	...
	Chart.defaults.doughnut = {
		...
		legend: {
			...
			onClick: function(e, legendItem) {
				helpers.each(this.chart.data.datasets, function(dataset) {
					...
					var idx = legendItem.StudentIndex;
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.StudentIndex] + ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.StudentIndex];
				}
			}
		}
	};
	...
	Chart.defaults.polarArea = {
		...
		tooltips: {
			callbacks: {
				title: function() { return ''; },
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.StudentIndex] + ': ' + tooltipItem.yLabel;
				}
			}
		}
	};
